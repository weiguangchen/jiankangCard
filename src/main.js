...
export default {
  ...
  config: {
    ...
    pages: ['pages/index/main','pages/fenxiao/main', 'pages/me/main','pages/address/main','pages/pay/main','pages/loginFenxiao/main','pages/detail/main','pages/order/main','pages/selectAdd/main','pages/chongzhi/main','pages/chongzhiDetail/main','^pages/tixian/main' ],
    window: {
